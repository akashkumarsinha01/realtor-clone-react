...
export default function CreateListing() {
    ...
    const{type,name,bedrooms,bathrooms,parking,furnish,address,description,offer,regularPrice,discountedPrice} = formData;
    function onChange(){}
  return (
        ...
        <form>
            ...
            <div className='flex space-x-6 mb-6'>
                <div>
                    ...
                    <input type="number" id="bedrooms" value={bedrooms} onChange={onChange} min="1" max="50" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-l-gray-300 rounded transition decoration-purple-100 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'/>
                </div>
                <div>
                    <p className='text-lg font-semibold'>Baths</p>
                    <input type="number" id="bathrooms" value={bathrooms} onChange={onChange} min="1" max="50" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-l-gray-300 rounded transition decoration-purple-100 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center'/>
                </div>
            </div>
